...
tasks {
    ...
    val pdfTasks = listOf(
        ...
        register(taskName, Deck2Pdf::class) {
            ...
            destinationFile.set(layout.buildDirectory.file("pdf/$htmlFilename-declarative-gradle-slides.pdf"))
    ...
    val html = register("zipHtml", Zip::class) {
        archiveBaseName = "declarative-gradle-slides"
...
gitPublish {
    repoUri = "git@github.com:eskatos/declarative-kotlinconf-2024.git"
    branch = "gh-pages"
    contents {
