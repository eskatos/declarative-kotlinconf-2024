...
* Read link:https://blog.gradle.org/declarative-gradle-first-eap[]
* Visit link:https://declarative.gradle.org[declarative.gradle.org] 
* Join https://gradle.org/slack-invite[] +
  [.small]#`#declarative-gradle`#
* Fill out link:https://community.gradle.org/surveys/developer-survey[]